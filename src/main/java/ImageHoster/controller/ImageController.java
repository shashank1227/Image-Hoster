...
public class ImageController {
    ...
    public String createImage(@RequestParam("file") MultipartFile file, @RequestParam(value = "tags", required = false) String tags, Image newImage, HttpSession session) throws IOException {
        ...
        List<Tag> imageTags = findOrCreateTags(tags == null ? "" : tags);
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam(value = "tags", required = false) String tags, Image updatedImage, HttpSession session) throws IOException {
